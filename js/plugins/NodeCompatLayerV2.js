...
(function () {
	...
	var __publicField = function (obj, key, value) {
		return __defNormalProp(
			obj,
			(typeof key === "undefined" ? "undefined" : _typeof(key)) !== "symbol" ? key + "" : key,
			value,
		);
	};
	...
	var require_Stats = __commonJS({
		"../../node_modules/.pnpm/memfs@4.50.0/node_modules/memfs/lib/node/Stats.js": function (exports) {
			...
			var _constants_1_constants = constants_1.constants,
				S_IFMT = _constants_1_constants.S_IFMT,
				S_IFDIR = _constants_1_constants.S_IFDIR,
				S_IFREG = _constants_1_constants.S_IFREG,
				S_IFBLK = _constants_1_constants.S_IFBLK,
				S_IFCHR = _constants_1_constants.S_IFCHR,
				S_IFLNK = _constants_1_constants.S_IFLNK,
				S_IFIFO = _constants_1_constants.S_IFIFO,
				S_IFSOCK = _constants_1_constants.S_IFSOCK;
	...
	var require_buffer2 = __commonJS({
		"../../node_modules/.pnpm/memfs@4.50.0/node_modules/memfs/lib/vendor/node/internal/buffer.js": function (exports) {
			...
			var bufferV0P12Ponyfill = function bufferV0P12Ponyfill(arg0) {
				...
				return _construct(buffer_1.Buffer, [arg0].concat(_toConsumableArray(args)));
			};
			Object.defineProperty(exports, "__esModule", {
				value: true,
			});
			...
			var promisify = function promisify(fn) {
				...
				return function () {
					...
					return new Promise(function (resolve, reject) {
						...
						(_fn = fn).call.apply(
							_fn,
							[_this].concat(_toConsumableArray(args), [
								function (err, result) {
									if (err) {
										reject(err);
									} else {
			...
			var makeNodeError = function makeNodeError(Base) {
				return /*#__PURE__*/ (function (Base) {
					...
					function NodeError(key) {
						...
						_this[kCode] = key;
						_this.name = ""
							.concat(_get((_assertThisInitialized(_this), _getPrototypeOf(NodeError.prototype)), "name", _this), " [")
							.concat(_this[kCode], "]");
						return _this;
					}
					return NodeError;
				...
				function AssertionError(options) {
					...
					if (options.message) {
						...
						_this = _super.call(
							this,
							""
								.concat((0, util_1.inspect)(options.actual).slice(0, 128), " ")
								.concat(options.operator, " ")
								.concat((0, util_1.inspect)(options.expected).slice(0, 128)),
						);
					}
				...
				function flatten(pathPrefix, node) {
					for (var path in node) {
						...
						if (typeof contentOrNode === "string" || _instanceof(contentOrNode, buffer_1.Buffer)) {
							...
							contentOrNode !== null &&
							!_instanceof(contentOrNode, buffer_1.Buffer) &&
	...
	var require_Node = __commonJS({
		"../../node_modules/.pnpm/memfs@4.50.0/node_modules/memfs/lib/core/Node.js": function (exports) {
			...
			var getuid = function () {
				...
				return (_process_1_default_getuid =
					(_process_1_default_getuid1 = (_process_1_default = process_1.default).getuid) === null ||
					_process_1_default_getuid1 === void 0
						? void 0
						: _process_1_default_getuid1.call(_process_1_default)) !== null && _process_1_default_getuid !== void 0
					? _process_1_default_getuid
					: 0;
			};
			var _process_1_default_getgid;
			var getgid = function () {
				var _process_1_default, _process_1_default_getgid1;
				return (_process_1_default_getgid =
					(_process_1_default_getgid1 = (_process_1_default = process_1.default).getgid) === null ||
					_process_1_default_getgid1 === void 0
						? void 0
						: _process_1_default_getgid1.call(_process_1_default)) !== null && _process_1_default_getgid !== void 0
					? _process_1_default_getgid
					: 0;
			};
				...
				_createClass(Node, [
					...
					},
					{
						...
						value: function write(buf) {
							var off = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0,
								len = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : buf.length,
								pos = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 0;
					...
					},
					{
						...
						value: function read(buf) {
							var off = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0,
								len = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : buf.byteLength,
								pos = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 0;
							this.atime = /* @__PURE__ */ new Date();
							...
							var buf2 = _instanceof(buf, buffer_1.Buffer)
								? buf
								: buffer_1.Buffer.from(buf.buffer, buf.byteOffset, buf.byteLength);
					...
					},
					{
						...
						value: function canRead() {
							var uid = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : getuid(),
								gid = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : getgid();
							if (this.perm & 4) {
								return true;
							}
							if (gid === this.gid) {
				...
				_createClass(_Link, [
					{
						...
						set: function set(val) {
							...
							try {
								for (
									var _iterator = this.children.entries()[Symbol.iterator](), _step;
									!(_iteratorNormalCompletion = (_step = _iterator.next()).done);
									_iteratorNormalCompletion = true
								) {
					...
					},
					{
						...
						value: function createChild(name) {
							var node =
								arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.vol.createNode(S_IFREG | 438);
					...
					},
					{
						...
						value: function setChild(name) {
							var link =
								arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : new _Link(this.vol, this, name);
			...
			var File = /*#__PURE__*/ (function () {
				...
				_createClass(File, [
					...
					},
					{
						...
						value: function write(buf) {
							var offset = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0,
								length = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : buf.length,
								position = arguments.length > 3 ? arguments[3] : void 0;
					...
					},
					{
						...
						value: function read(buf) {
							var offset = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0,
								length = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : buf.byteLength,
								position = arguments.length > 3 ? arguments[3] : void 0;
							if (typeof position !== "number") position = this.position;
	...
	var require_constants2 = __commonJS({
		"../../node_modules/.pnpm/memfs@4.50.0/node_modules/memfs/lib/node/constants.js": function (exports) {
			...
			var _constants_1_constants = constants_1.constants,
				O_RDONLY = _constants_1_constants.O_RDONLY,
				O_WRONLY = _constants_1_constants.O_WRONLY,
				O_RDWR = _constants_1_constants.O_RDWR,
				O_CREAT = _constants_1_constants.O_CREAT,
				O_EXCL = _constants_1_constants.O_EXCL,
				O_TRUNC = _constants_1_constants.O_TRUNC,
				O_APPEND = _constants_1_constants.O_APPEND,
				O_SYNC = _constants_1_constants.O_SYNC;
			var FLAGS;
			(function (FLAGS2) {
	...
	var require_util3 = __commonJS({
		"../../node_modules/.pnpm/memfs@4.50.0/node_modules/memfs/lib/node/util.js": function (exports) {
			...
			var formatError = function formatError(errorCode) {
				var func = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "",
					path = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "",
					path2 = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : "";
				var pathFormatted = "";
				...
				switch (errorCode) {
					...
					case ERR_FS_EISDIR:
						return "[ERR_FS_EISDIR]: Path is a directory: "
							.concat(func, " returned EISDIR (is a directory) ")
							.concat(path);
			...
			var createError = function createError(errorCode) {
				var func = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "",
					path = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "",
					path2 = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : "",
					Constructor = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : Error;
	...
	var require_Superblock = __commonJS({
		"../../node_modules/.pnpm/memfs@4.50.0/node_modules/memfs/lib/core/Superblock.js": function (exports) {
			...
			var _constants_1_constants = constants_1.constants,
				...
				O_TRUNC = _constants_1_constants.O_TRUNC,
				O_APPEND = _constants_1_constants.O_APPEND,
				O_DIRECTORY = _constants_1_constants.O_DIRECTORY;
			var Superblock = /*#__PURE__*/ (function () {
				function _Superblock() {
					...
					this.readv = function (fd, buffers, position) {
						...
						try {
							for (
								var _iterator = buffers[Symbol.iterator](), _step;
								!(_iteratorNormalCompletion = (_step = _iterator.next()).done);
								_iteratorNormalCompletion = true
							) {
					...
					this.rename = function (oldPathFilename, newPathFilename) {
						...
						link.name = name;
						link.steps = _toConsumableArray(newPathDirLink.steps).concat([name]);
					...
					this.rm = function (filename) {
						var force = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false,
							recursive = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
						var _link_parent;
						var link;
						try {
						...
						if (
							!((_link_parent = link.parent) === null || _link_parent === void 0
								? void 0
								: _link_parent.getNode().canWrite())
						)
					...
					[
						{
							...
							value: function createLink(parent, name) {
								var isDirectory = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false,
									mode = arguments.length > 3 ? arguments[3] : void 0;
								if (!parent) {
						...
						},
						{
							...
							value: function walk(stepsOrFilenameOrLink) {
								var resolveSymlinks = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false,
									checkExistence = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false,
									checkAccess = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : false,
									funcName = arguments.length > 4 ? arguments[4] : void 0;
								var steps;
								var filename;
								...
								while (i < steps.length) {
									...
									var _curr_getChild;
									curr =
										(_curr_getChild = curr.getChild(steps[i])) !== null && _curr_getChild !== void 0
											? _curr_getChild
											: null;
									if (!curr)
										if (checkExistence) throw (0, util_1.createError)("ENOENT", funcName, filename);
										else return null;
									node = curr === null || curr === void 0 ? void 0 : curr.getNode();
									if (node.isSymlink() && (resolveSymlinks || i < steps.length - 1)) {
										var resolvedPath = (0, path_1.isAbsolute)(node.symlink)
											? node.symlink
						...
						},
						{
							...
							value: function getLinkParentAsDirOrThrow(filenameOrSteps, funcName) {
								var steps = (
									_instanceof(filenameOrSteps, Array) ? filenameOrSteps : (0, util_2.filenameToSteps)(filenameOrSteps)
								).slice(0, -1);
						...
						},
						{
							...
							value: function _toJSON() {
								var link = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : this.root,
									json = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {},
									path = arguments.length > 2 ? arguments[2] : void 0,
									asBuffer = arguments.length > 3 ? arguments[3] : void 0;
								var isEmpty = true;
								...
								try {
									for (
										var _iterator = children.keys()[Symbol.iterator](), _step;
										!(_iteratorNormalCompletion = (_step = _iterator.next()).done);
										_iteratorNormalCompletion = true
									) {
						...
						},
						{
							...
							value: function toJSON(paths) {
								var json = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {},
									isRelative = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false,
									asBuffer = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : false;
								var links = [];
								if (paths) {
								...
								try {
									for (
										var _iterator1 = links[Symbol.iterator](), _step1;
				...
				_createClass(FileHandle, [
					...
					},
					{
						...
						value: function readableWebStream() {
							...
							var _this = this;
							var _options_type = options.type,
								type = _options_type === void 0 ? "bytes" : _options_type,
								_options_autoClose = options.autoClose,
								autoClose = _options_autoClose === void 0 ? false : _options_autoClose;
							var position = 0;
							if (this.fd === -1) {
										...
										return __generator(this, function (_state) {
											switch (_state.label) {
												case 0:
													...
													view =
														(_controller_byobRequest = controller.byobRequest) === null ||
														_controller_byobRequest === void 0
															? void 0
															: _controller_byobRequest.view;
													if (!!view) return [3, 2];
													buffer = new Uint8Array(16384);
													return [4, _this1.read(buffer, 0, buffer.length, position)];
												case 1:
													result2 = _state.sent();
													...
													return [2];
												case 2:
													return [4, _this1.read(view, view.byteOffset, view.byteLength, position)];
												case 3:
													result = _state.sent();
		...
		"../../node_modules/.pnpm/memfs@4.50.0/node_modules/memfs/lib/node/FsPromises.js": function (exports) {
						...
						value: function enqueueEvent(event) {
							...
							if (this.eventQueue.length >= this.maxQueue) {
								if (this.overflow === "throw") {
									...
									console.warn(
										"Watch queue overflow: dropping event due to exceeding maxQueue of ".concat(this.maxQueue),
									);
								}
							}
					...
					},
					{
						...
						value: function finish(error) {
							...
							while (this.resolveQueue.length > 0) {
								var _this_resolveQueue_shift = this.resolveQueue.shift(),
									resolve = _this_resolveQueue_shift.resolve,
									reject = _this_resolveQueue_shift.reject;
								if (error) {
									reject(error);
								} else {
									resolve({
			...
			var FsPromises = function FsPromises(fs, FileHandle) {
				...
				this.appendFile = function (path, data, options) {
					return (0, util_1.promisify)(_this.fs, "appendFile")(
						_instanceof(path, _this.FileHandle) ? path.fd : path,
						data,
						options,
					);
				};
				this.open = function (path) {
					var flags = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "r",
				...
				this.writeFile = function (id, data, options) {
					var dataPromise = (0, util_1.isReadableStream)(data)
						? (0, util_1.streamToBuffer)(data)
						: Promise.resolve(data);
					return dataPromise.then(function (data2) {
						return (0, util_1.promisify)(_this.fs, "writeFile")(
							_instanceof(id, _this.FileHandle) ? id.fd : id,
							data2,
							options,
						);
					});
	...
	var require_printTree = __commonJS({
		"../../node_modules/.pnpm/tree-dump@1.1.0_tslib@2.8.1/node_modules/tree-dump/lib/printTree.js": function (exports) {
			...
			var printTree = function () {
				var tab = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "",
					children = arguments.length > 1 ? arguments[1] : void 0;
				var str = "";
	...
	var require_printBinary = __commonJS({
		"../../node_modules/.pnpm/tree-dump@1.1.0_tslib@2.8.1/node_modules/tree-dump/lib/printBinary.js": function (
			exports,
		) {
			"use strict";
			Object.defineProperty(exports, "__esModule", {
	...
	var require_printJson = __commonJS({
		"../../node_modules/.pnpm/tree-dump@1.1.0_tslib@2.8.1/node_modules/tree-dump/lib/printJson.js": function (exports) {
			...
			var printJson = function () {
				var tab = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "",
					json = arguments.length > 1 ? arguments[1] : void 0,
					space = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 2;
	...
	var require_util4 = __commonJS({
		"../../node_modules/.pnpm/memfs@4.50.0/node_modules/memfs/lib/node-to-fsa/util.js": function (exports) {
			...
			var assertName = function (name, method, klass) {
				...
				if (isInvalid)
					throw new TypeError("Failed to execute '".concat(method, "' on '").concat(klass, "': Name is not allowed."));
			};
		...
		"../../node_modules/.pnpm/memfs@4.50.0/node_modules/memfs/lib/node/options.js": function (exports) {
			...
			var getStatOptsAndCb = function (options, callback) {
				return typeof options === "function"
					...
					: [(0, exports.getStatOptions)(options), (0, util_1.validateCallback)(callback)];
			};
	...
	var require_lib2 = __commonJS({
		"../../node_modules/.pnpm/glob-to-regex.js@1.2.0_tslib@2.8.1/node_modules/glob-to-regex.js/lib/index.js": function (
			exports,
		) {
			"use strict";
			Object.defineProperty(exports, "__esModule", {
			...
			var parseExtGlob = function (pattern, startIdx, prefix, options) {
				...
				for (var j = 0; j < length; j++)
					alternatives +=
						(alternatives ? "|" : "") +
						(0, exports.toRegex)(parts[j], options).source.replace(/^\^/, "").replace(/\$$/, "");
				switch (prefix) {
					case "?":
						return ["(?:".concat(alternatives, ")?"), i];
					case "*":
						return ["(?:".concat(alternatives, ")*"), i];
					case "+":
						return ["(?:".concat(alternatives, ")+"), i];
			...
			var toMatcher = function (pattern, options) {
				...
				try {
					for (
						var _iterator = patterns[Symbol.iterator](), _step;
						!(_iteratorNormalCompletion = (_step = _iterator.next()).done);
						_iteratorNormalCompletion = true
					) {
						var pat = _step.value;
	...
	var require_glob = __commonJS({
		"../../node_modules/.pnpm/memfs@4.50.0/node_modules/memfs/lib/node/glob.js": function (exports) {
			...
			var isExcluded = function isExcluded(path, exclude) {
				...
				var patterns = Array.isArray(exclude) ? exclude : [exclude];
			...
			var globSync = function globSync(fs, pattern) {
				...
				if (path_1.posix.isAbsolute(pattern)) {
					...
					var _results1;
					var dirResults1 = walkDirectory(fs, resolvedCwd, [pattern], globOptions);
			...
			function walkDirectory(fs, dir, patterns, options) {
				...
				var maxDepth =
					(_options_maxdepth = options.maxdepth) !== null && _options_maxdepth !== void 0
						? _options_maxdepth
						: Infinity;
	...
	var require_volume = __commonJS({
		"../../node_modules/.pnpm/memfs@4.50.0/node_modules/memfs/lib/node/volume.js": function (exports) {
			...
			var resolveCrossPlatform = path_1.resolve;
			var _constants_1_constants = constants_1.constants,
				O_SYMLINK = _constants_1_constants.O_SYMLINK,
				F_OK = _constants_1_constants.F_OK,
				R_OK = _constants_1_constants.R_OK,
				W_OK = _constants_1_constants.W_OK,
				X_OK = _constants_1_constants.X_OK,
				COPYFILE_EXCL = _constants_1_constants.COPYFILE_EXCL,
				COPYFILE_FICLONE_FORCE = _constants_1_constants.COPYFILE_FICLONE_FORCE;
			var pathSep = path_1.posix ? path_1.posix.sep : path_1.sep;
			var pathRelative = path_1.posix ? path_1.posix.relative : path_1.relative;
			var pathJoin = path_1.posix ? path_1.posix.join : path_1.join;
			...
			var Volume = /*#__PURE__*/ (function () {
				function Volume() {
					...
					this.open = function (path, flags, a, b) {
						...
						var fileName = (0, util_2.pathToFilename)(path);
						var flagsNum = (0, util_2.flagsToNumber)(flags);
						_this.wrapAsync(_this._core.open, [fileName, flagsNum, modeNum, !(flagsNum & O_SYMLINK)], callback);
					};
					...
					this.close = function (fd, callback) {
						...
						_this.wrapAsync(_this._core.close, [file.fd], callback);
					};
					...
					this.readv = function (fd, buffers, a, b) {
						...
						var callback = b;
						var ref;
						if (typeof a === "function") ((ref = [null, a]), (position = ref[0]), (callback = ref[1]), ref);
						(0, util_2.validateCallback)(callback);
						Promise.resolve().then(function () {
							try {
					...
					this.readFile = function (id, a, b) {
						var _ref = _slicedToArray((0, options_1.optsAndCbGenerator)(options_1.getReadFileOptions)(a, b), 2),
							opts = _ref[0],
							callback = _ref[1];
						var flagsNum = (0, util_2.flagsToNumber)(opts.flag);
						_this.wrapAsync(_this._readfile, [id, flagsNum, opts.encoding], callback);
					};
					this.writeSync = function (fd, a, b, c, d) {
						var _ref = _slicedToArray((0, util_2.getWriteSyncArgs)(fd, a, b, c, d), 5),
							buf = _ref[1],
							offset = _ref[2],
							length = _ref[3],
							position = _ref[4];
					...
					this.write = function (fd, a, b, c, d, e) {
						var _ref = _slicedToArray((0, util_2.getWriteArgs)(fd, a, b, c, d, e), 7),
							asStr = _ref[1],
							buf = _ref[2],
							offset = _ref[3],
							length = _ref[4],
					...
					this.writeFile = function (id, data, a, b) {
						...
						var ref;
						if (typeof a === "function")
							((ref = [options_1.writeFileDefaults, a]), (options = ref[0]), (callback = ref[1]), ref);
						var cb = (0, util_2.validateCallback)(callback);
						var opts = (0, options_1.getWriteFileOptions)(options);
						var flagsNum = (0, util_2.flagsToNumber)(opts.flag);
						var modeNum = (0, util_2.modeToNumber)(opts.mode);
						var buf = (0, util_3.dataToBuffer)(data, opts.encoding);
						_this.wrapAsync(_this._core.writeFile, [id, buf, flagsNum, modeNum], cb);
					};
					...
					this.copyFile = function (src, dest, a, b) {
						...
						var callback;
						var ref, ref1;
						if (typeof a === "function") ((ref = [0, a]), (flags = ref[0]), (callback = ref[1]), ref);
						else ((ref1 = [a, b]), (flags = ref1[0]), (callback = ref1[1]), ref1);
						(0, util_2.validateCallback)(callback);
						_this.wrapAsync(_this._copyFile, [srcFilename, destFilename, flags], callback);
					};
					this._cp = function (src, dest, options) {
						...
						if (srcStat.isDirectory() && _this.isSrcSubdir(src, dest))
							throw (0, util_2.createError)("EINVAL", "cp", src, dest);
						ENDURE_PARENT_DIR_EXISTS: {
							var parent = pathDirname(dest);
							if (!_this.existsSync(parent))
								_this.mkdirSync(parent, {
									recursive: true,
								});
						}
					...
					this.link = function (existingPath, newPath, callback) {
						var existingPathFilename = (0, util_2.pathToFilename)(existingPath);
						var newPathFilename = (0, util_2.pathToFilename)(newPath);
						_this.wrapAsync(_this._core.link, [existingPathFilename, newPathFilename], callback);
					};
					...
					this.unlink = function (path, callback) {
						var filename = (0, util_2.pathToFilename)(path);
						_this.wrapAsync(_this._core.unlink, [filename], callback);
					};
					...
					this.symlink = function (target, path, a, b) {
						...
						var targetFilename = (0, util_2.pathToFilename)(target);
						var pathFilename = (0, util_2.pathToFilename)(path);
						_this.wrapAsync(_this._core.symlink, [targetFilename, pathFilename], callback);
					};
					this._lstat = function (filename) {
						var bigint = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false,
							throwIfNoEntry = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
						var link;
						try {
					...
					this.lstatSync = function (path, options) {
						var _ref = (0, options_1.getStatOptions)(options),
							_ref_throwIfNoEntry = _ref.throwIfNoEntry,
							throwIfNoEntry = _ref_throwIfNoEntry === void 0 ? true : _ref_throwIfNoEntry,
							_ref_bigint = _ref.bigint,
							bigint = _ref_bigint === void 0 ? false : _ref_bigint;
					...
					this.rename = function (oldPath, newPath, callback) {
						var oldPathFilename = (0, util_2.pathToFilename)(oldPath);
						var newPathFilename = (0, util_2.pathToFilename)(newPath);
						_this.wrapAsync(_this._core.rename, [oldPathFilename, newPathFilename], callback);
					};
					...
					this.access = function (path, a, b) {
						...
						var ref;
						if (typeof a !== "function")
							((ref = [a | 0, (0, util_2.validateCallback)(b)]), (mode = ref[0]), (callback = ref[1]), ref);
						else callback = a;
						var filename = (0, util_2.pathToFilename)(path);
						_this.wrapAsync(_this._access, [filename, mode], callback);
					};
					...
					this.appendFile = function (id, data, a, b) {
						var _ref = _slicedToArray((0, options_1.getAppendFileOptsAndCb)(a, b), 2),
							opts = _ref[0],
							callback = _ref[1];
						if (!opts.flag || (0, util_3.isFd)(id)) opts.flag = "a";
					...
					this._readdir = function (filename, options) {
						...
						try {
							for (
								var _iterator = link.children.keys()[Symbol.iterator](), _step;
								!(_iteratorNormalCompletion = (_step = _iterator.next()).done);
								_iteratorNormalCompletion = true
							) {
								var name = _step.value;
					...
					this.readdir = function (path, a, b) {
						var _ref = _slicedToArray((0, options_1.getReaddirOptsAndCb)(a, b), 2),
							options = _ref[0],
							callback = _ref[1];
						var filename = (0, util_2.pathToFilename)(path);
						_this.wrapAsync(_this._readdir, [filename, options], callback);
					};
					...
					this.readlink = function (path, a, b) {
						var _ref = _slicedToArray((0, options_1.getDefaultOptsAndCb)(a, b), 2),
							opts = _ref[0],
							callback = _ref[1];
						var filename = (0, util_2.pathToFilename)(path);
						_this.wrapAsync(_this._readlink, [filename, opts.encoding], callback);
					};
					...
					this.fsync = function (fd, callback) {
						_this.wrapAsync(_this._fsync, [fd], callback);
					};
					...
					this.fdatasync = function (fd, callback) {
						_this.wrapAsync(_this._fdatasync, [fd], callback);
					};
					...
					this.ftruncate = function (fd, a, b) {
						...
						_this.wrapAsync(_this._ftruncate, [fd, len], callback);
					};
					...
					this.truncate = function (id, a, b) {
						...
						_this.wrapAsync(_this._truncate, [id, len], callback);
					};
					...
					this.futimes = function (fd, atime, mtime, callback) {
						_this.wrapAsync(_this._futimes, [fd, toUnixTimestamp(atime), toUnixTimestamp(mtime)], callback);
					};
					...
					this.utimes = function (path, atime, mtime, callback) {
						_this.wrapAsync(
							_this._utimes,
							[(0, util_2.pathToFilename)(path), toUnixTimestamp(atime), toUnixTimestamp(mtime), true],
							callback,
						);
					};
					...
					this.lutimes = function (path, atime, mtime, callback) {
						_this.wrapAsync(
							_this._utimes,
							[(0, util_2.pathToFilename)(path), toUnixTimestamp(atime), toUnixTimestamp(mtime), false],
							callback,
						);
					};
					...
					this.mkdir = function (path, a, b) {
						...
						var modeNum = (0, util_2.modeToNumber)(opts.mode, 511);
						var filename = (0, util_2.pathToFilename)(path);
						if (opts.recursive) _this.wrapAsync(_this._core.mkdirp, [filename, modeNum], callback);
						else _this.wrapAsync(_this._core.mkdir, [filename, modeNum], callback);
					};
					...
					this.mkdtemp = function (prefix, a, b) {
						var _ref = _slicedToArray((0, options_1.getDefaultOptsAndCb)(a, b), 2),
							encoding = _ref[0].encoding,
							callback = _ref[1];
						if (!prefix || typeof prefix !== "string") throw new TypeError("filename prefix is required");
						if (!(0, util_2.nullCheck)(prefix)) return;
						_this.wrapAsync(_this._mkdtemp, [prefix, encoding], callback);
					};
					...
					this.rmdir = function (path, a, b) {
						...
						var callback = (0, util_2.validateCallback)(typeof a === "function" ? a : b);
						_this.wrapAsync(_this._core.rmdir, [(0, util_2.pathToFilename)(path), opts.recursive], callback);
					};
					...
					this.rm = function (path, a, b) {
						var _ref = _slicedToArray((0, options_1.getRmOptsAndCb)(a, b), 2),
							opts = _ref[0],
							callback = _ref[1];
						_this.wrapAsync(
							_this._core.rm,
					...
					this.fchmod = function (fd, mode, callback) {
						_this.wrapAsync(_this._fchmod, [fd, (0, util_2.modeToNumber)(mode)], callback);
					};
					this._chmod = function (filename, modeNum) {
						var followSymlinks = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
						var link = followSymlinks
							? _this._core.getResolvedLinkOrThrow(filename, "chmod")
							: _this._core.getLinkOrThrow(filename, "chmod");
						var node = link.getNode();
						node.chmod(modeNum);
					};
					...
					this.chmod = function (path, mode, callback) {
						var modeNum = (0, util_2.modeToNumber)(mode);
						var filename = (0, util_2.pathToFilename)(path);
						_this.wrapAsync(_this._chmod, [filename, modeNum], callback);
					};
					...
					this.lchmod = function (path, mode, callback) {
						var modeNum = (0, util_2.modeToNumber)(mode);
						var filename = (0, util_2.pathToFilename)(path);
						_this.wrapAsync(_this._lchmod, [filename, modeNum], callback);
					};
					...
					this.fchown = function (fd, uid, gid, callback) {
						validateUid(uid);
						validateGid(gid);
						_this.wrapAsync(_this._fchown, [fd, uid, gid], callback);
					};
					...
					this.chown = function (path, uid, gid, callback) {
						validateUid(uid);
						validateGid(gid);
						_this.wrapAsync(_this._chown, [(0, util_2.pathToFilename)(path), uid, gid], callback);
					};
					...
					this.lchown = function (path, uid, gid, callback) {
						validateUid(uid);
						validateGid(gid);
						_this.wrapAsync(_this._lchown, [(0, util_2.pathToFilename)(path), uid, gid], callback);
					};
					this.statWatchers = {};
					this.cpSync = function (src, dest, options) {
						var srcFilename = (0, util_2.pathToFilename)(src);
						var destFilename = (0, util_2.pathToFilename)(dest);
						var _options_dereference,
							_options_errorOnExist,
							_options_force,
							_options_mode,
							_options_preserveTimestamps,
							_options_recursive,
							_options_verbatimSymlinks;
						var opts_ = {
							dereference:
								(_options_dereference = options === null || options === void 0 ? void 0 : options.dereference) !==
									null && _options_dereference !== void 0
									? _options_dereference
									: false,
							errorOnExist:
								(_options_errorOnExist = options === null || options === void 0 ? void 0 : options.errorOnExist) !==
									null && _options_errorOnExist !== void 0
									? _options_errorOnExist
									: false,
							filter: options === null || options === void 0 ? void 0 : options.filter,
							force:
								(_options_force = options === null || options === void 0 ? void 0 : options.force) !== null &&
								_options_force !== void 0
									? _options_force
									: true,
							mode:
								(_options_mode = options === null || options === void 0 ? void 0 : options.mode) !== null &&
								_options_mode !== void 0
									? _options_mode
									: 0,
							preserveTimestamps:
								(_options_preserveTimestamps =
									options === null || options === void 0 ? void 0 : options.preserveTimestamps) !== null &&
								_options_preserveTimestamps !== void 0
									? _options_preserveTimestamps
									: false,
							recursive:
								(_options_recursive = options === null || options === void 0 ? void 0 : options.recursive) !== null &&
								_options_recursive !== void 0
									? _options_recursive
									: false,
							verbatimSymlinks:
								(_options_verbatimSymlinks =
									options === null || options === void 0 ? void 0 : options.verbatimSymlinks) !== null &&
								_options_verbatimSymlinks !== void 0
									? _options_verbatimSymlinks
									: false,
						};
					...
					this.cp = function (src, dest, a, b) {
						...
						var callback;
						var ref, ref1;
						if (typeof a === "function") ((ref = [{}, a]), (options = ref[0]), (callback = ref[1]), ref);
						else ((ref1 = [a || {}, b]), (options = ref1[0]), (callback = ref1[1]), ref1);
						(0, util_2.validateCallback)(callback);
						var _options_dereference,
							_options_errorOnExist,
							_options_force,
						...
						_this.wrapAsync(_this._cp, [srcFilename, destFilename, opts_], callback);
					};
					var _this1 = this;
					...
					this.glob = function (pattern) {
						...
						var _ref = _slicedToArray(args.length === 1 ? [{}, args[0]] : [args[0], args[1]], 2),
							options = _ref[0],
							callback = _ref[1];
						_this.wrapAsync(_this._globSync, [pattern, options || {}], callback);
					};
					...
					this.opendir = function (path, a, b) {
						var _ref = _slicedToArray((0, options_1.getOpendirOptsAndCb)(a, b), 2),
							options = _ref[0],
							callback = _ref[1];
						var filename = (0, util_2.pathToFilename)(path);
						_this.wrapAsync(_this._opendir, [filename, options], callback);
					};
					var self = this;
					...
					this.ReadStream = /*#__PURE__*/ (function (_ReadStream) {
						...
						function _class() {
							...
							_classCallCheck(this, _class);
							return _super.call.apply(_super, [this, self].concat(_toConsumableArray(args)));
						}
						return _class;
					})(_ReadStream);
					...
					var realpathImpl = function (path, a, b) {
						var _ref = _slicedToArray((0, options_1.getRealpathOptsAndCb)(a, b), 2),
							opts = _ref[0],
							callback = _ref[1];
						var pathFilename = (0, util_2.pathToFilename)(path);
				...
				_createClass(Volume, [
					...
					},
					{
						...
						value: function lstat(path, a, b) {
							var _ref = _slicedToArray((0, options_1.getStatOptsAndCb)(a, b), 2),
								_ref_ = _ref[0],
								_ref__throwIfNoEntry = _ref_.throwIfNoEntry,
								throwIfNoEntry = _ref__throwIfNoEntry === void 0 ? true : _ref__throwIfNoEntry,
								_ref__bigint = _ref_.bigint,
								bigint = _ref__bigint === void 0 ? false : _ref__bigint,
								callback = _ref[1];
					...
					},
					{
						...
						value: function _stat(filename) {
							var bigint = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false,
								throwIfNoEntry = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
							var link;
							try {
					...
					},
					{
						...
						value: function statSync(path, options) {
							var _ref = (0, options_1.getStatOptions)(options),
								_ref_bigint = _ref.bigint,
								bigint = _ref_bigint === void 0 ? true : _ref_bigint,
								_ref_throwIfNoEntry = _ref.throwIfNoEntry,
								throwIfNoEntry = _ref_throwIfNoEntry === void 0 ? true : _ref_throwIfNoEntry;
					...
					},
					{
						...
						value: function watch(path, options, listener) {
							...
							var _ref = (0, options_1.getDefaultOpts)(givenOptions),
					...
					},
					{
						...
						value: function statfsSync(path, options) {
							var _ref = (0, options_1.getStatfsOptions)(options),
								_ref_bigint = _ref.bigint,
								bigint = _ref_bigint === void 0 ? false : _ref_bigint;
					...
					},
					{
						...
						value: function statfs(path, a, b) {
							var _ref = _slicedToArray((0, options_1.getStatfsOptsAndCb)(a, b), 2),
								_ref_ = _ref[0],
								_ref__bigint = _ref_.bigint,
								bigint = _ref__bigint === void 0 ? false : _ref__bigint,
								callback = _ref[1];
				...
				_createClass(StatWatcher, [
					...
					},
					{
						...
						value: function start(path) {
							var persistent = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true,
								interval = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 5007;
			...
			FsReadStream.prototype.close = function (cb) {
				...
				if (
					typeof ((_this__readableState = this._readableState) === null || _this__readableState === void 0
						? void 0
						: _this__readableState.closed) === "boolean"
				) {
			...
			FsWriteStream.prototype._write = function (data, encoding, cb) {
				if (!(_instanceof(data, buffer_1.Buffer) || _instanceof(data, Uint8Array)))
			...
			FsWriteStream.prototype.close = function (cb) {
				...
				if (
					typeof ((_this__writableState = this._writableState) === null || _this__writableState === void 0
						? void 0
						: _this__writableState.closed) === "boolean"
				) {
				...
				_createClass(FSWatcher, [
					...
					},
					{
						...
						value: function start(path) {
							var persistent = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true,
								recursive = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false,
								encoding = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : encoding_1.ENCODING_UTF8;
							var _this = this;
							...
							var watchLinkNodeChanged = function (link) {
								...
								var removers =
									(_this__listenerRemovers_get = _this._listenerRemovers.get(node.ino)) !== null &&
									_this__listenerRemovers_get !== void 0
										? _this__listenerRemovers_get
										: [];
							...
							var watchLinkChildrenChanged = function (link) {
								...
								var onLinkChildDelete = function (l) {
									var removeLinkNodeListeners = function (curLink) {
										...
										try {
											for (
												var _iterator = curLink.children.entries()[Symbol.iterator](), _step;
												!(_iteratorNormalCompletion = (_step = _iterator.next()).done);
												_iteratorNormalCompletion = true
											) {
												var _step_value = _slicedToArray(_step.value, 2),
													name = _step_value[0],
													childLink = _step_value[1];
								...
								try {
									for (
										var _iterator = link.children.entries()[Symbol.iterator](), _step;
										!(_iteratorNormalCompletion = (_step = _iterator.next()).done);
										_iteratorNormalCompletion = true
									) {
										var _step_value = _slicedToArray(_step.value, 2),
								...
								if (recursive) {
									...
									try {
										for (
											var _iterator1 = link.children.entries()[Symbol.iterator](), _step1;
											!(_iteratorNormalCompletion1 = (_step1 = _iterator1.next()).done);
											_iteratorNormalCompletion1 = true
										) {
											var _step_value1 = _slicedToArray(_step1.value, 2),
												name1 = _step_value1[0],
												childLink1 = _step_value1[1];
					...
					},
					{
						...
						value: function close() {
							...
							(_this__parentChangesUnsub = (_this = this)._parentChangesUnsub) === null ||
							_this__parentChangesUnsub === void 0
								? void 0
								: _this__parentChangesUnsub.call(_this);
						},
					},
				]);
				return FSWatcher;
	...
	var require_fsSynchronousApiList = __commonJS({
		"../../node_modules/.pnpm/memfs@4.50.0/node_modules/memfs/lib/node/lists/fsSynchronousApiList.js": function (
			exports,
		) {
			"use strict";
			Object.defineProperty(exports, "__esModule", {
	...
	var require_lib3 = __commonJS({
		"../../node_modules/.pnpm/memfs@4.50.0/node_modules/memfs/lib/index.js": function (exports, module) {
			...
			var createFsFromVolume = function createFsFromVolume(vol2) {
				...
				try {
					for (
						var _iterator = fsSynchronousApiList_1.fsSynchronousApiList[Symbol.iterator](), _step;
						!(_iteratorNormalCompletion = (_step = _iterator.next()).done);
						_iteratorNormalCompletion = true
					) {
				...
				try {
					for (
						var _iterator1 = fsCallbackApiList_1.fsCallbackApiList[Symbol.iterator](), _step1;
						!(_iteratorNormalCompletion1 = (_step1 = _iterator1.next()).done);
						_iteratorNormalCompletion1 = true
					) {
			...
			var memfs = function () {
				var json = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {},
					cwd = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "/";
		...
		get: function get(target, prop) {
			...
			if (!cachedFunc) {
				cachedFunc = methodMap[prop] = function cachedFunc() {
					...
					advanceResults.set(
						this,
						(_ittrProxiedCursorToOriginalProxy_get = ittrProxiedCursorToOriginalProxy.get(this))[prop].apply(
							_ittrProxiedCursorToOriginalProxy_get,
			...
			return __generator(this, function (_state) {
				switch (_state.label) {
					case 0:
						...
						cursor = this;
						if (!!_instanceof(cursor, IDBCursor)) return [3, 2];
						return [4, _awaitAsyncGenerator((_cursor = cursor).openCursor.apply(_cursor, _toConsumableArray(args)))];
					case 1:
						cursor = _state.sent();
						_state.label = 2;
					case 2:
					...
					case 3:
						...
						return [4, proxiedCursor];
					case 4:
						_state.sent();
						return [4, _awaitAsyncGenerator(advanceResults.get(proxiedCursor) || cursor.continue())];
					case 5:
						cursor = _state.sent();
						...
						return __generator(this, function (_state) {
							switch (_state.label) {
								...
								case 1:
									...
									return [4, _this.db.put(_this.storeName, value, key)];
								case 2:
									_state.sent();
									return [3, 4];
								case 3:
					...
					return _asyncToGenerator(function () {
						...
						return __generator(this, function (_state) {
							switch (_state.label) {
								...
								case 1:
									_state.trys.push([1, 3, , 4]);
									return [4, _this.db.get(_this.storeName, key)];
								case 2:
					...
					return _asyncToGenerator(function () {
						...
						return __generator(this, function (_state) {
							switch (_state.label) {
								...
								case 1:
									_state.trys.push([1, 3, , 4]);
									return [4, _this.db.delete(_this.storeName, key)];
								case 2:
									_state.sent();
									return [3, 4];
								case 3:
					...
					return _asyncToGenerator(function () {
						...
						return __generator(this, function (_state) {
							switch (_state.label) {
								...
								case 1:
									_state.trys.push([1, 3, , 4]);
									return [4, _this.db.clear(_this.storeName)];
								case 2:
									_state.sent();
				...
				return __generator(this, function (_state) {
					switch (_state.label) {
						case 0:
							...
							if (!this.isBrowser) return [3, 3];
							console.log("[NodeCompatLayerV2] Running in browser environment, setting up compatibility layer...");
							this.setupVirtualFS();
							if (!this.config.enablePersistence) return [3, 2];
							return [4, this.initPersistence()];
						case 1:
							_state.sent();
							_state.label = 2;
						case 2:
		 ...
		 */ function initPersistence() {
			return _asyncToGenerator(function () {
				...
				return __generator(this, function (_state) {
					switch (_state.label) {
						case 0:
							_state.trys.push([0, 3, , 4]);
							return [4, this.persistence.init()];
						case 1:
							_state.sent();
				...
				return __generator(this, function (_state) {
					switch (_state.label) {
						...
						case 1:
							...
							try {
								for (
									_iterator = Object.entries(snapshot)[Symbol.iterator]();
									!(_iteratorNormalCompletion = (_step = _iterator.next()).done);
									_iteratorNormalCompletion = true
								) {
							...
							try {
								...
								if (this.config.verbose) {
									console.log(
										"[NodeCompatLayerV2] Saved ".concat(Object.keys(smallFiles).length, " small files to localStorage"),
									);
								}
							} catch (error1) {
							...
							_state.label = 2;
						case 2:
							_state.trys.push([2, 7, 8, 9]);
							_iterator1 = Object.entries(largeFiles)[Symbol.iterator]();
							_state.label = 3;
						case 3:
							if (!!(_iteratorNormalCompletion1 = (_step1 = _iterator1.next()).done)) return [3, 6];
							((_step_value1 = _slicedToArray(_step1.value, 2)),
								(path1 = _step_value1[0]),
								(content1 = _step_value1[1]));
							return [4, this.persistence.save("file:".concat(path1), content1)];
						case 4:
							_state.sent();
							_state.label = 5;
						case 5:
						...
						case 9:
							if (Object.keys(largeFiles).length > 0 && this.config.verbose) {
								console.log(
									"[NodeCompatLayerV2] Saved ".concat(Object.keys(largeFiles).length, " large files to IndexedDB"),
								);
							}
							return [
								4,
						...
						case 1:
							...
							try {
								...
								if (smallData) {
									...
									if (this.config.verbose) {
										console.log(
											"[NodeCompatLayerV2] Loaded ".concat(
												Object.keys(smallFiles).length,
												" small files from localStorage",
											),
										);
									}
								}
							...
							return [4, this.persistence.load("metadata")];
						case 2:
							...
							if (Object.keys(files).length > 0) {
								...
								console.log(
									"[NodeCompatLayerV2] Restored ".concat(Object.keys(files).length, " files from persistent storage"),
								);
							} else {
								if (this.config.verbose) {
		 ...
		 */ enableAutosave: function enableAutosave() {
			...
			window.addEventListener("beforeunload", function () {
				try {
					...
					try {
						for (
							var _iterator = Object.entries(snapshot)[Symbol.iterator](), _step;
							!(_iteratorNormalCompletion = (_step = _iterator.next()).done);
							_iteratorNormalCompletion = true
						) {
							var _step_value = _slicedToArray(_step.value, 2),
				...
				return __generator(this, function (_state) {
					switch (_state.label) {
						case 0:
							...
							return [4, this.persistence.clear()];
						case 1:
							_state.sent();
